...
1. **Manual File Copy:** Selective, controlled updates
2. **Matrixify:** Complete theme export/import
3. **Shopify CLI:** Push entire theme to multiple stores

**Best Practice:** Develop on US store first, then replicate to other stores after testing.
